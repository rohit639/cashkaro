...
@Listeners(com.cashkaro.util.ListnersClass.class)
public class BaseWebdriver {
	...
	private void setDriverPath() {
		if (Configuration.getbrowser().equalsIgnoreCase("chrome")) {
			...
			logger.info("Please check browser name provided. it should be eitehr firefox or chrome");
			System.exit(1);
		}
	...
	private Path getPlatform() {
		...
		if (PlatformUtil.isMac()) {
			...
			logger.info("Platform should be one of these Mac/Windows/linux. Failed as test platform is :"
